...
/**
 * Classe que define um Ingresso para o público dos Idosos
 * 
 * @author Alessandro
 *
 */
public class IngressoIdoso implements Ingresso, CalculadoraDeIngresso {
	
	private Double PRECO = 6d;
	...
	public Double getValorIngressoDomingo() {
		return  Utils.roundUp((PRECO * 0.95));
	}
	...
	public Double getValorIngressoQuartaFeira() {
		return  Utils.roundUp((PRECO * 0.6));
	}
